...
export function installTemplate(source: string): Promise<{ name: string; status: string; activated: string }> {
...
/**
 * Install a template from inline content generated by the AI agent.
 * This calls the same /api/templates/install endpoint as installTemplate(),
 * but sends file content directly instead of a source URL.
 */
...
export function installTemplateInline(
  payload: InlineTemplatePayload,
